<template>
	<view class="app" :style="styleCom">
		<uni-nav-bar title="支付成功" style="{font-size: 32rpx; font-weight: bold;}" :border="false" backgroundColor="#01be6e" color="#fff" leftIcon="left" @clickLeft="onBack"></uni-nav-bar>
		<view class="header">
